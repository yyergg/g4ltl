...
int exp;
    ...
    jj_consume_token(0);
     ...
     if(debug){System.out.println();} {if (true) return exp;}
 ...
 *
 */
  final public int StateTerm() throws ParseException {
int state;
    if (jj_2_9(4)) {
      ...
      throw new ParseException();
         ...
         {if (true) return bdd.ref(state);}
    throw new Error("Missing return statement in function");
  }

  final public int AndTerm() throws ParseException {
int andTerm = bdd.getOne();
int temp = bdd.getOne();
    if (jj_2_11(4)) {
      temp = GroundTerm();
                                     andTerm = bdd.andTo(andTerm, temp);
    } else if (jj_2_12(4)) {
      temp = NotTerm();
                                  andTerm = bdd.andTo(andTerm, temp);
    } else {
    ...
    while (true) {
      ...
      if (jj_2_21(4)) {
        ...
        break label_1;
         ...
         {if (true) return andTerm;}
    throw new Error("Missing return statement in function");
  }

  final public int OrTerm() throws ParseException {
int orTerm = bdd.getZero();
int temp = bdd.getZero();
    if (jj_2_22(4)) {
      temp = GroundTerm();
                                     orTerm = bdd.orTo(orTerm, temp);
    } else if (jj_2_23(4)) {
      temp = NotTerm();
                                  orTerm = bdd.orTo(orTerm, temp);
    } else {
    ...
    while (true) {
      ...
      if (jj_2_26(4)) {
        ...
        break label_2;
         ...
         {if (true) return orTerm;}
    throw new Error("Missing return statement in function");
  }

  final public int ImpliesTerm() throws ParseException {
...
int temp2 = bdd.getZero();
    ...
    if (jj_2_43(4)) {
      ...
      throw new ParseException();
         ...
         {if (true) return bdd.imp(temp1,temp2);}
    throw new Error("Missing return statement in function");
  }

  final public int NotTerm() throws ParseException {
int temp;
    jj_consume_token(NOT);
                if(debug){System.out.print("NOT ");}
    temp = GroundTerm();
         {if (true) return bdd.not(temp);}
    throw new Error("Missing return statement in function");
  }
 ...
 *
 */
  final public int GroundTerm() throws ParseException {
        Token predicateName;
    predicateName = jj_consume_token(STRING);
                                if(debug){System.out.print(predicateName.image+" ");}
                if(predicateName.image.equalsIgnoreCase("true")){
                        {if (true) return bdd.getZero();}
                } else if (predicateName.image.equalsIgnoreCase("false")){
                        {if (true) return bdd.getZero();}
                } else {
                        {if (true) return createAtomic(predicateName.image);}
                }
    throw new Error("Missing return statement in function");
  }
